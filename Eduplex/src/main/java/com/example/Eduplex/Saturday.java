...
public class Saturday extends Fragment {
    ...
    public Saturday(String _class,String _section){
        this._class=_class;
    ...
    private void intialise() {
        ...
        {
            DatabaseReference MONDAYNODE = FirebaseDatabase.getInstance().getReference().child("School").child("TimetableRecord").child(_class).child(_section).child("Saturday");
            MONDAYNODE.addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                    if (snapshot.exists()) {
                        ...
                        saturdayTimetable.setAdapter(new TimetableAdapter(timetable, view.getContext()));
                    }
                }
